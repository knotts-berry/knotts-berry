    ...
    <>
      <nav className="alignfull main-menu order-1 bg-secondary-100 py-2 px-4 text-center text-xs font-bold md:text-sm">
        {home ? (
          ...
          <ul className="inline-flex flex-wrap items-center justify-center gap-5 md:gap-8">
            <li className="uppercase">
              <Link href="/" className="text-primary-400 no-underline">
                Home
              </Link>
            </li>
            <li className="uppercase">
              <Link href="recipe-development" className="text-primary-400 no-underline">
                レシピ開発
              </Link>
            </li>
            {/* <li className="uppercase">
              <Link href="recruit" className="text-primary-400 no-underline">求人情報</Link>
            </li> */}
            <li className="uppercase">
              <Link href="inquiry" className="text-primary-400 no-underline">
                お問合せ
              </Link>
            </li>
            <li className="uppercase">
